...
""" % bcb_dev)
  ...
  script.Print("*********************************************")
  script.Print("*      ___           __      ____  __    __ *")
  script.Print("*   __| _/  _____  _/  |_   / ___\ \ \  / / *")
  script.Print("*  / __ |  / ___ \ \   __\ / /___   \ \/ /  *")
  script.Print("* / /  /| / /   \ \ |  |   \ \___   / /\ \  *")
  script.Print("*/ /__/ | \ \___/ / |  |    \____/ /_/  \_\ *")
  script.Print("*\____  |  \_____/  `__\ *Droid On Time*    *")
  script.Print("*     \/                   |Extended|       *")
